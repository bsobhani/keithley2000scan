...
/* Generated from ../O.Common/keithley2000Scan.dbd */
...
int keithley2000Scan_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"keithley2000Scan_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    keithley2000Scan_registerRecordDeviceDriver(*iocshPpdbbase);
}
